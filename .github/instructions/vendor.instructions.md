...
Make sure we have comitted the full vendor folder, so it can be installed as expected
Make sure that the version of simplesamlphp installed is the one listed in thirdpartylibs.xml
Make sure all the patches in the patches folder have sucessfully applied
