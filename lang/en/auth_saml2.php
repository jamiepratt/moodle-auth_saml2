...
$string['eventmetadatachangeapproved'] = 'IdP metadata security change approved';
$string['eventmetadatachangedetected'] = 'IdP metadata security change detected';
...
$string['idpmetadata_emptydisallowed'] = 'IdP metadata cannot be empty. Existing active metadata was preserved.';
...
$string['idpmetadata_httpsrequired'] = 'Remote IdP metadata must use HTTPS.';
$string['idpmetadata_invalid'] = 'The IdP XML isn\'t valid';
$string['idpmetadata_noentityid'] = 'The IdP XML has no entityID';
$string['idpmetadata_nopending'] = 'There is no staged IdP metadata change to approve.';
$string['idpmetadata_pendingapproval'] = 'A signing key, security endpoint, or metadata source changed. The current metadata remains active until the Moodle SAML service owner approves the change after out-of-band confirmation with the IdP. An emergency delegate may approve when the owner is unavailable; Moodle records the decision.';
$string['idpmetadata_pendinginvalid'] = 'The staged IdP metadata failed its integrity check and was not activated.';
$string['idpmetadata_pendingwritefailed'] = 'The proposed IdP metadata could not be staged securely.';
$string['idpmetadata_writefailed'] = 'The IdP metadata could not be written to the live configuration.';
...
$string['metadataapproval'] = 'Approve IdP metadata security change';
$string['metadataapproval_help'] = 'Review a staged signing-key, endpoint, or metadata-source change. The live configuration remains unchanged until approval.';
$string['metadataapprovalactivate'] = 'Approve and activate';
$string['metadataapprovalauthority'] = 'Approval authority';
$string['metadataapprovalconfirmationrequired'] = 'Out-of-band IdP confirmation is required before activation.';
...
$string['metadataapprovalfingerprint'] = 'Proposal SHA-256 fingerprint';
$string['metadataapprovalindex'] = 'Index';
$string['metadataapprovalisdefault'] = 'isDefault';
$string['metadataapprovalnotset'] = 'not specified';
$string['metadataapprovalsource'] = 'Metadata source';
$string['metadataapprovalsourceinline'] = 'Inline XML';
$string['metadataapprovalsourceremote'] = 'Remote HTTPS URL';
$string['metadataapprovalentity'] = 'Entity ID';
$string['metadataapprovalsigningkey'] = 'Signing key fingerprint';
$string['metadataapprovalendpoint'] = 'Security endpoint';
$string['metadataapprovalbinding'] = 'Binding';
...
$string['metadataapprovalwarning'] = 'Activate only after the Moodle SAML service owner has confirmed the change with the IdP through a separate trusted channel. Use the emergency delegate only when the owner is unavailable.';
